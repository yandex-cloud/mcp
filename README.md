...
| [🚦 Event Router MCP Server (Preview)](./servers/eventrouter-mcp-server/README.md) | Create event-driven architectures with buses, connectors, and routing rules for filtering and event processing | [Install](./servers/eventrouter-mcp-server/README.md#prerequisites) |
